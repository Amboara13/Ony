...
public class FenetreDeJeuSauvegarder extends JFrame {

    private JeuDePointsPanel jeu;

    public FenetreDeJeuSauvegarder() {
        super("Jeu de Points");

        jeu = new JeuDePointsPanel(); // Création de l'instance de JeuDePointsPanel

        // Panel principal avec BorderLayout
        JPanel panelPrincipal = new JPanel(new BorderLayout());

        
        // Ajout des labels au panel des noms des joueurs
